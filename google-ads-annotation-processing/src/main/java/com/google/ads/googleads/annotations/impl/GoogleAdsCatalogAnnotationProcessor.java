...
import com.google.ads.googleads.annotations.impl.generators.messageproxy.CustomerUserAccessProxyGenerator;
...
public class GoogleAdsCatalogAnnotationProcessor extends AbstractProcessor {
  ...
  private Collection<Generator> loadGenerators(
    ...
    return ImmutableList.of(
        ...
        new CustomerUserAccessProxyGenerator(versions, messager, filer));
  }
